...
import json
import numpy as np
def preprocess_and_save(input_path1,input_path2, output_path):
    """
    对原始数据进行预处理，并保存到硬盘
    """
...
if __name__ == "__main__":
    preprocess_and_save(
        "/home/rspip/zay/ir_json_dataset/train",
        "/home/rspip/zay/ir_json_dataset/test",
        "/home/rspip/zay/ir_json_dataset/train.pkl")
